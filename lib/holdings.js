...
async function getHoldings(wallet) {
  ...
  // Actual staked/used capacity isn't tracked on-chain yet — DUMPSTR is expected to
  // surface this as an NFT attribute once the token + staking protocol goes live.
